...
export const DISCUSSION_SYSTEM = `Report what commenters actually said concesiely without mentioning one by one. just the whole ideas with reasons said in comments. Just their takes, disagreements, and insights — no introduction, no framing, no 'commenters discuss'. Start directly with the substance.  concisely just mention points of negativew points and positive points.`;
